...
% updates: 
%
% 03/02/10 boric acid pressure coefficient (10^3*a2)
%          corrected: 2.608 -> -2.608.  
...
bor = 1.*(432.5*(S./35.))*1.e-6; % 416 DOE94, 432.5 Lee10
...
%  Deleted by Jess Adkins on Aug 1, 2010 to avoid an inner matrix multiply error
...
pco2 = co2*1e6/kh;												%  Deleted a factor of 10^6 from this expression, JFA Aug 1, 2010
